   ...
   <h2 class="h2">서비스 이용약관</h2>
    <div class="agree">
       ...
       <br>제1조 (목적)<br>
        ...
        "산행동행"은 귀하가 본 약관 내용에 동의하는 경우, "산행동행"의 서비스 제공 행위 및 귀하의 서비스 사용 행위에 본 약관이 우선적으로 적용됩니다. "산행동행"는 본 약관을 사전 고지 없이 변경할 수 있고, 변경된 약관은 이용자가 직접 확인할 수 있도록 서비스 화면에 공지하며, 공지와 동시에 그 효력이 발생됩니다. 이용자가 변경된 약관에 동의하지 않는 경우, 이용자는 본인의 회원등록을 취소(회원탈퇴)할 수 있으며 계속 사용의 경우는 약관 변경에 대한 동의로 간주됩니다.<br>
       <br>제3조 (약관 외 준칙)<br>
        ...
        1. 이용자 : 이 약관에 따라 "산행동행"이 제공하는 서비스를 받는자<br>
          2. 가입 : “산행동행”이 제공하는 신청서 양식에 해당 정보를 기입하고, 이 약관에 동의하여 서비스 이용계약을 완료시키는 행위<br>
      3. 회원 : "산행동행"에 개인정보 등 관련 정보를 제공하여 회원등록을 한 자로서, 일반회원과 정부혁신담당 공직자 회원으로 나뉨<br>
      4. 비밀번호 : 이용자와 회원ID가 일치하는지를 확인하고 통신상의 자신의 비밀보호를 위하여 이용자 자신이 선정한 문자와 숫자의 조합<br>
      5. 이용해지 : "산행동행" 또는 회원이 서비스 이용 이후 그 이용계약을 종료시키는 의사표시<br>
      ② 이 약관에서 사용하는 용어의 정의는 제1항에서 정하는 것을 제외하고는 관계법령 및 서비스별 안내에서 정하는 바에 의합니다.<br>
      
      <br><br>제2장 서비스 이용계약<br><br>
      <br>제5조 (이용계약의 성립)<br>
      이용계약은 이용자가 약관내용을 동의하고 "산행동행"에서 제공하는 소정의 회원 가입신청 양식에서 요구하는 사항을 기록하여 가입을 완료한 후 "산행동행"가 회원가입을 승낙하면 성립됩니다.<br>
      <br>제6조 (이용계약의 유보와 거절)<br>
      ① "산행동행"은 다음 각 호에 해당하는 이용계약에 대하여는 그 제한 사유가 해소될 때까지 일부 서비스 이용을 제한하거나 가입을 제한할 수 있습니다.<br>
      1. 신청서의 내용이 허위(차명 등)인 것으로 판명되거나, 그러하다고 의심할만한 합리적인 사유가 발생할 경우<br>
      2. 사회의 안녕 질서 또는 미풍양속을 저해할 목적으로 신청한 경우<br>
      3. 기타 "산행동행"" 정한 이용계약 요건에 미비 되었을 경우<br>
      ② "산행동행은" 다음에 해당하는 경우 그 사유가 해소될 때까지 이용계약 성립을 유보할 수 있습니다.<br>
      ...
      1. “산행동행”은 서비스 제공과 관련해서 수집된 회원의 신상정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 정보통신윤리위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우, 귀하가 “산행동행”에 제공한 개인정보를 스스로 공개한 경우에는 그러하지 않습니다.<br>
      ...
      4. 회원이 이 약관에 따라 이용신청을 하는 것은, 신청서에 기재된 회원정보를 "산행동행"이 수집, 이용하는 것에 동의하는 것으로 간주됩니다.<br>
      
      <br><br>제3장 서비스 제공 및 이용<br><br>
      <br>제9조 (서비스 이용)<br>
      ① "산행동행"이 회원의 이용신청을 수락한 때부터 서비스를 개시합니다. 단, 일부 서비스의 경우에는 지정된 일자부터 서비스를 개시합니다.<br>
      ② 서비스의 이용 시간은 연중무휴 1일 24시간을 원칙으로 합니다. 다만, "산행동행"의 업무상 또는 기술상의 이유, 정기점검 등으로 서비스가 일시 중지될 수 있습니다. 이러한 경우 "산행동행"은 사전 또는 사후에 이를 공지합니다.<br>
      ③ 회원에 가입한 후라도 일부 서비스 이용 시 서비스 제공자의 요구에 따라 특정 회원에게만 서비스를 제공할 수도 있습니다.<br>
      ④"산행동행"은 서비스를 일정범위로 분할하여 각 범위별로 이용가능 시간을 별도로 정할 수 있습니다. 이 경우 그 내용을 사전에 공지합니다.<br>
      제10조 (서비스의 변경, 중지 및 정보의 저장과 사용)<br>
      ① 이용자는 "산행동행"에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 국가의 비상사태, 정전, "산행동행"의 관리범위 외의 서비스 설비 장애 및 기타 불가항력에 의하여 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실에 대해 "산행동행"이 아무런 책임을 지지 않음에 동의합니다.<br>
      ② "산행동행"이 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는 서비스 중지 1주일 전에 고지 후 서비스를 중지할 수 있으며, 이 기간동안 회원이 고지내용을 인지하지 못한데 대하여 "정부혁신1번가"는 책임을 부담하지 아니합니다. 부득이한 사정이 있을 경우 위 사전 고지기간은 감축되거나 생략될 수 있습니다. 또한 위 서비스 중지에 의하여 본 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 대하여도 "정부혁신1번가"는 책임을 부담하지 아니합니다.<br>
      ③ "산행동행"이 사전 고지 후 서비스를 일시적으로 수정, 변경 및 중단할 수 있으며, 이에 대하여 회원 또는 제3자에게 어떠한 책임도 부담하지 아니합니다.
      ④ "산행동행"의 사정으로 서비스를 영구적으로 중단하여야 할 경우 제2항을 준용합니다. 다만, 이 경우 사전 고지기간은 1개월로 합니다.<br>
      ⑤ "산행동행"은 이용자가 이 약관의 내용에 위배되는 행동을 한 경우, 임의로 서비스 사용을 제한 및 중지할 수 있습니다. 이 경우 "산행동행"은 이용자의 접속을 금지할 수 있으며, 이용자가 게시한 내용의 전부 또는 일부를 임의로 삭제할 수 있습니다.<br>
      ⑥ 장기간 휴면 회원인 경우 자체적으로 서비스 사용을 중지할 수 있습니다.<br>
      <br>제11조 (정보의 제공 및 광고의 게재)<br>
      ① "산행동행"은 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보 및 광고에 대해서는 E-mail이나 서신우편물, 전화, SMS(휴대폰 문자메시지), 메신저 등의 방법으로 회원에게 제공할 수 있으며, 만약 원치 않는 정보를 수신한 경우 회원은 이를 수신거부 할 수 있습니다.<br>
      ② "산행동행"은  서비스의 운용과 관련하여 서비스화면, 홈페이지, 전자우편 등에 홍보물 및 광고 등을 게재할 수 있으며, 서비스를 이용하고자 하는 회원 및 이용자가 이에 대하여 동의하는 것으로 간주합니다.<br>
      ③ "산행동행"은  서비스 상에 게재되어 있거나 서비스를 통한 광고주와의 판촉활동에 회원이 참여하거나 교신 또는 거래의 결과로서 발생하는 모든 손실 또는 손해에 대해 책임을 지지 않습니다.<br>
      <br>제12조 (게시물 또는 내용물의 관리)<br>
      ①"산행동행"은  회원이 게시하거나 등록하는 서비스 내의 내용물이 다음 각 호의 경우에 해당된다고 판단되는 경우 사전 통지 없이 삭제할 수 있으며, 이에 대해 "정부혁신1번가"는 어떠한 책임도 지지 않습니다.<br>
      1. "산행동행"은  다른 회원 또는 제3자를 비방하거나 중상모략으로 명예를 손상시키는 내용인 경우<br>
      ...
      ②"산행동행"은  서비스 제공 목적에 부합할 경우 회원이 서비스에 게시한 내용을 사전 통지없이 편집 또는 이동할 수 있는 권리를 보유합니다.<br>
      ③"산행동행"은  게시된 내용이 일정기간 이상 경과되어, 게시물로서의 효력을 상실하여 그 존치 목적이 불분명한 경우 해당 게시물을 삭제할 수 있습니다.<br>
      <br>제13조 (게시물의 저작권)<br>
      ① 회원이 서비스 내에 게시한 게시물의 저작권은 회원에게 있으며, "산행동행"은  다른 서비스에서의 개재 등 서비스 내의 게시물을 활용할 수 있습니다.<br>
      ...
      <br>제14조 (""산행동행"의 소유권)<br>
      ① ""산행동행"의 제공하는 서비스, 그에 필요한 소프트웨어, 이미지, 마크, 로고, 디자인, 서비스명칭, 정보 및 상표 등과 관련된 지적재산권 및 기타권리는 행정안전부에 소유권이 있습니다.<br>
      ② 회원은 ""산행동행" 또는 행정안전부가 명시적으로 승인한 경우를 제외하고는 제1항 소정의 각 재산에 대한 전부 또는 일부의 수정, 대여, 대출, 판매, 배포, 제작, 양도, 재라이센스, 담보권 설정행위, 상업적 이용행위를 할 수 없으며, 제3자로 하여금 이와 같은 행위를 하도록 허락할 수 없습니다.<br>
      
      <br><br>제4장 계약 당사자의 의무<br><br>
      <br>제15조 (회원의 의무 및 정보보안)<br>
      ① 회원이 서비스 사용을 위한 가입절차를 완료하시면 아이디와 비밀 번호를 받게 됩니다. 회원의 아이디, 비밀번호 관리를 위해 본인의 승인 없이 비밀번호, 아이디가 사용되는 문제가 발생되면 즉시 "산행동행"에 신고하셔야 합니다.<br>
      ...
      6. "산행동행”의 사전 승낙 없이 서비스를 이용한 영리행위<br>
      ...
      <br>제16조 ("산행동행”의 의무)<br>
      ① "산행동행"의 이 약관에서 정한 바에 따라 계속적, 안정적인 서비스를 제공하기 위하여 노력할 의무가 있습니다.<br>
      ② "산행동행"의 제공하는 서비스로 인하여 회원에게 손해가 발생한 경우 그러한 손해가 "산행동행"의 고의나 중과실에 기해 발생한 경우에 한하여 "정부혁신1번가"에서 책임을 부담하며, 그 책임의 범위는 통상손해에 한합니다.<br>
      ③ "산행동행"의 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 신속히 처리하여야 합니다. 다만, 신속한 처리가 곤란한 경우에는 회원에게 그 사유와 처리일정을 통보하여야 합니다.<br>
      ④ "산행동행"는 관련법령이 정하는 바에 따라서 회원 등록정보를 포함한 회원의 개인정보를 보호하기 위하여 노력합니다. 회원의 개인정보보호에 관해서는 관련법령 및 제 8조와 제 16조에 제시된 내용을 지킵니다.<br>
      <br>제17조 (개인정보보호정책)<br>
      ①"산행동행"의 이용 신청 시 회원이 제공하는 정보를 통하여 회원에 관한 정보를 수집하며, 회원의 개인정보는 본 이용계약의 이행과 본 이용계약상의 서비스제공을 위한 목적으로 이용합니다.<br>
      ②"산행동행"는 서비스 제공과 관련하여 취득한 회원의 정보를 본인의 승낙 없이 제3자에게 누설 또는 배포할 수 없으며 상업적 목적으로 사용할 수 없습니다. 다만, 다음의 각 호의 경우에는 그러하지 아니합니다.<br>
      ...
      ② "산행동행"의 보안 및 아이디 정책, 서비스의 원활한 제공 등과 같은 이유로 회원의 아이디 및 비밀번호 변경을 요구하거나 변경 할 수 있습니다.<br>
      ③ "산행동행"은 회원이 다음 각 호에 해당하는 행위를 하였을 경우 사전통지 없이 이용계약을 해지할 수 있습니다.<br>
      ...
      <br>제21조 (손해배상)<br>
      "산행동행"은 무료로 제공되는 서비스와 관련하여 회원에게 어떠한 손해가 발생하더라도 동 손해가 "산행동행"의 중대한 과실에 의한 경우를 제외하고 이에 대하여 책임을 부담하지 아니합니다.<br>
      <br>제22조 (면책조항)<br>
      ① "산행동행"은 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우, 기간통신 사업자가 전기통신 서비스를 중지하거나 정상적으로 제공하지 아니하여 손해가 발생한 경우, 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 손해가 발생한 경우에는 서비스 제공에 관한 책임이 면제됩니다.<br>
      ② "산행동행"은 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여 책임을 지지 않습니다.<br>
      ③ "산행동행"은 회원이나 제3자에 의해 표출된 어떠한 의견이나 정보에 대해 확신이나 대표할 의무가 없으며 의견을 승인하거나 반대하거나 수정하지 않습니다.<br>
      ④ "산행동행"은 회원 또는 기타 유관기관이 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등에 관하여 보장하지 않습니다.<br>
      ⑤ "산행동행"은 회원이 서비스를 이용하여 기대하는 이익이나 서비스를 통하여 얻은 자료로 인한 일체의 손실이나 손해에 관하여 책임을 지지 않습니다.<br>
      ⑥ "산행동행"은 이용자가 서비스 이용과 관련하여 이용자간에 발생한 손해 중 이용자의 고의, 과실에 의한 손해 및 타 이용자로 인하여 입게 되는 정신적 피해에 대하여 보상할 책임지지 않습니다.<br>
      제23조 (관할법원)<br>
      ① 서비스 이용과 관련하여 "산행동행"은 회원 사이에 분쟁이 발생한 경우,"산행동행"은 회원은 발생한 분쟁을 원만하게 해결하기 위하여 필요한 모든 노력을 하여야 합니다<br>
      ② 제1항의 규정에도 불구하고 서비스 이용으로 발생한 분쟁에 대하여 소송이 제기될 경우 ""산행동행" 소재지를 관할하는 법원을 관할법원으로 합니다.<br>
      부 칙<br>
    ...
    <br>
    <h2 class="h2">개인정보 수집·이용 동의</h2>
    <div class="agree">
        <div tabindex="0">
      <br>개인정보보호정책<br>
     <br>산행동행의 이용을 위해 수집한 귀하의 정보를 관리함에 있어서 「개인정보보호법」에서 규정하고 있는 책임과 의무를 준수하고 제공자가 동의한 내용 외 다른 목적으로는 활용하지 않음을 알려드립니다.<br>
      - 개인정보 수집이용 목적 : 회원가입 및 본인인증,기타 서비스 제공 등<br>
      - 수집하려는 개인정보 항목<br>
      <br>* 산행동행 회원의 경우<br>
      - 필수 : 아이디, 비밀번호, 닉네임, 생년월일,이메일<br>
      <br>* 산행동행 카카오 SNS계정 인증가입의 경우<br>
      - 필수 : 아이디, 성명<br>
